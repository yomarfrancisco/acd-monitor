...
def run_leadlag(snapshot, output_dir, results):
    ...
    cmd = [
        ...
        "--use-overlap-json", str(overlap_json),
        "--export-dir", str(output_dir / "evidence"),
        "--verbose"
    ]
...
def main():
    ...
    parser.add_argument("--snapshot", required=True, help="Snapshot path (baselines/2s or court/1s)")
    parser.add_argument("--modules", default="leadlag,infoshare,spread", 
