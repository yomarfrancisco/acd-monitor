#!/usr/bin/env python3
"""
Beacon Stress-Test — Mid-Run Checkpoint & Early-Stop (GROUND TRUTH ONLY)
"""
...
# --- MAIN EXECUTION ---
log("=== Beacon Stress-Test — Mid-Run Checkpoint & Early-Stop ===")
...
# 2. Test configurations with early-stop rules
