...
def download_sep_w3():
    """Download and validate September Week 3 data"""
    ...
    # Save validation log
    with open(f'{output_dir}/ingest_sep_w3_validity.log', 'w') as f:
        f.write("SEPTEMBER WEEK 3 DOWNLOAD AND VALIDATION LOG\n")
        f.write("=" * 80 + "\n")
        f.write(f"Download timestamp: {datetime.now().isoformat()}\n")
        f.write(f"Date range: 2025-09-15 to 2025-09-21\n")
    ...
    print(f"📁 {output_dir}/ingest_sep_w3_validity.log")
