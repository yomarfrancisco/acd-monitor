CREATE OR REPLACE VIEW acd_derived.wave1_1s_snap_v1 AS
WITH src AS (
  SELECT
    from_unixtime(
      CASE
    ...
    venue,
    last_px AS price
  FROM acd_derived.btc_ticks_enriched_v3
