#!/usr/bin/env python3
"""
PROMPT 1: RX-Weekday-W-2 (Mon–Fri): RX-A″ + RX-B + RX-C
Goal: Run RX tests only for W-2 weekdays (Mon–Fri) using canonical beacons/ticks
"""
...
def main():
    print("📊 PROMPT 1: RX-WEEKDAY-W-2 (MON–FRI): RX-A″ + RX-B + RX-C")
    print("=" * 80)
    print("Goal: Run RX tests only for W-2 weekdays (Mon–Fri) using canonical beacons/ticks")
    ...
    if final_memory <= 750:
        print(f"✅ PROMPT 1 COMPLETE - All guardrails complied with")
        ...
        print(f"❌ PROMPT 1 HALTED")
        print(f"• Memory usage: {final_memory:.1f} MB > 750 MB limit")
    
    print(f"\nMemory usage: {final_memory:.1f} MB")
    print(f"PROMPT 1 COMPLETE — HALTED after report as requested.")
