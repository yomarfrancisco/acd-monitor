...
from acd.analytics.volatility_regimes import (
    VolatilityRegimeAnalyzer,
    create_volatility_regime_analyzer,
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run volatility regime analysis with structured logging"
    )
    parser.add_argument(
        "--days",
        type=int,
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="volatility_regime_results.json",
