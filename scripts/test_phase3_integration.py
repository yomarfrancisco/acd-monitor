...
def test_end_to_end_pipeline():
    ...
    pipeline_results = {
        "icp": {
            "success": True,
            "p_value": icp_result.p_value,
            "reject": icp_result.reject_h0,
        },
        "vmm": {
            "success": True,
            "converged": vmm_result.convergence_status == "converged",
        },
        "validation": {"success": True, "layers": len(validation_results)},
        "integrated": {
            "success": True,
            "risk_score": integrated_result.composite_risk_score,
        },
