...
class DeepS3Auditor:
    ...
    def deep_audit(self):
        ...
        btc_objects = [obj for obj in all_objects if 'BTC-USD' in obj['Key'] or 'btc' in obj['Key'].lower()]
        ...
        recent_objects = [obj for obj in btc_objects if '2025-09' in obj['Key'] or '2025-10' in obj['Key']]
