...
class Wave1TestExecutor:
    ...
    def _test_autocorrelation(self):
        ...
        print(
            f"    Tables: {self.plots_dir}/autocorrelations.csv, {self.plots_dir}/ar1_coefficients.csv"
        )
    ...
    def _test_pca_analysis(self):
        ...
        self.results["pca_analysis"] = {"data": pca_data, "summary": self._analyze_pca(pca_data)}
