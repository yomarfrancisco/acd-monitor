...
class Wave3VMMExecutor:
    ...
    def _prepare_moments_data(self, vmm_data: pd.DataFrame) -> Optional[pd.DataFrame]:
        ...
        moment_cols = [
            col for col in vmm_data.columns if any(x in col for x in ["mean", "var", "cov"])
        ]
    ...
    def _estimate_competitive_model(self, moments_data: pd.DataFrame) -> Dict:
        ...
        return {
            ...
            "parameters": {"phi": result.x[0], "alpha": result.x[1], "beta": result.x[2]},
    ...
    def _compare_models(
        self, m1_results: Dict, m2_results: Dict, moments_data: pd.DataFrame
    ) -> Dict:
        ...
        return {
            "j_statistics": {"M1_competitive": j1, "M2_coordination": j2, "delta_j": delta_j},
            "model_selection": {
    ...
    def _generate_vmm_outputs(self, m1_results: Dict, m2_results: Dict, comparison_results: Dict):
        ...
        estimates = {"M1_competitive": m1_results, "M2_coordination": m2_results}
    ...
    def _generate_vmm_summary(self, m1_results: Dict, m2_results: Dict, comparison_results: Dict):
        ...
        with open(summary_file, "w") as f:
            ...
            f.write(
                f"- **Evidence Strength**: {comparison_results['model_selection']['evidence_strength']}\n\n"
            )
