...
def calculate_fee_revenue(
    venue: str, notional_traded: float, fee_schedules: Dict, tier: str = "retail"
) -> float:
...
def calculate_episode_excess_revenue(
    episodes: List[Dict],
...
def run_venue_excess_revenue_analysis(
    snapshot_path: str,
    episodes_path: str,
...
def main():
    ...
    parser.add_argument(
        ...
        help="S3 bucket for fee schedules",
    )
    parser.add_argument(
        "--fee-key",
