...
def find_usable_windows(all_data: Dict[str, Dict[str, pd.DataFrame]], windows: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
...
def main():
    ...
    parser = argparse.ArgumentParser(description='ACD Phase GRID - Realistic Canonical Time Binning')
