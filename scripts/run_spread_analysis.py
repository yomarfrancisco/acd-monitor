...
from acd.analytics.spread_convergence import (
    SpreadConvergenceAnalyzer,
    create_spread_convergence_analyzer,
)
...
def run_spread_analysis(
    ...
    summary = {
        ...
        "export_files": ["spread_episodes.csv", "spread_leaders.json", "MANIFEST.json"],
    }
...
def main():
    ...
    try:
        ...
        print(
            f"Compression threshold: {results['results']['compression_threshold']*100}%"
        )
