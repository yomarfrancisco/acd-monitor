...
def generate_summary_report(infoshare_df: pd.DataFrame, spread_df: pd.DataFrame, leadlag_df: pd.DataFrame) -> str:
...
def main():
    ...
    parser.add_argument('--window-path', default='real_data_runs/20250926T204804__20250926T205752',
    ...
    total_kept_bonferroni = ((infoshare_df['bonferroni_p'] < 0.05).sum() if not infoshare_df.empty else 0) + \
