...
def timestamp_shuffle_test(
    mid_prices: pd.DataFrame, episodes: List[Dict], n_shuffles: int = 500
) -> Dict:
...
def venue_relabel_test(
    ...
    shuffle_leader_counts = {
        leader: shuffle_leaders.count(leader) for leader in set(shuffle_leaders)
    }
