...
def fetch_venue_data(venue: str, symbol: str, start_time: datetime, 
                    end_time: datetime, session: requests.Session) -> pd.DataFrame:
...
def calculate_micro_controls(venue_data: Dict[str, pd.DataFrame], 
...
def capture_window(symbol: str, start_time: datetime, end_time: datetime,
                  venues: List[str], bucket: str, prefix: str) -> bool:
