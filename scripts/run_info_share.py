...
def print_evidence_blocks(export_dir: str) -> None:
    ...
    print(
        "Pattern: grep -E '^\\[(MICRO:infoShare:env|STATS:infoShare:bootstrap|INFO:infoShare:assignments)' /tmp/acd_info_share.log"
    )
...
def main():
    ...
    parser.add_argument(
        "--max-lag", type=int, default=5, help="Maximum lag for VECM estimation"
    )
    parser.add_argument(
