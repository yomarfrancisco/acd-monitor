...
def episodes_overlap(ep1: Dict, ep2: Dict, min_intersection: float = 5.0, 
                    start_tolerance: float = 5.0) -> bool:
...
def find_matches(base_episodes: List[Dict], new_episodes: List[Dict], 
                min_intersection: float = 5.0, start_tolerance: float = 5.0) -> List[Tuple[int, int]]:
...
def calculate_jaccard_similarity(base_episodes: List[Dict], new_episodes: List[Dict], 
...
def run_replication_analysis(base_window_file: str, new_window_file: str,
                           min_intersection: float = 5.0, start_tolerance: float = 5.0,
                           export_dir: str = "experiments/phase5/replication") -> Dict:
    ...
    replication_flag = "PASS" if (replication_rate >= 0.50 or jaccard_similarity >= 0.35) else "FAIL"
...
def main():
    ...
    parser.add_argument("--t-start-tol", type=float, default=5.0, help="Start time tolerance in seconds")
    parser.add_argument("--min-intersection", type=float, default=5.0, help="Minimum intersection duration in seconds")
