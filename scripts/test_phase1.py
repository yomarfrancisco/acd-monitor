...
def test_phase1_implementation():
    ...
    print(
        f"   ✓ Competitive ICP - Effect size: {icp_result_competitive.effect_size:.4f}"
    )
    ...
    print(
        f"   ✓ Coordinated ICP - Effect size: {icp_result_coordinated.effect_size:.4f}"
    )
    ...
    enhanced_icp_competitive = icp_engine.analyze_invariance_enhanced(
        competitive_data, price_cols
    )
    print(
        f"   ✓ Enhanced ICP Competitive - Reject H0: {enhanced_icp_competitive.reject_h0}"
    )
    print(
        f"   ✓ Enhanced ICP Competitive - P-value: {enhanced_icp_competitive.p_value:.4f}"
    )
    print(
    ...
    enhanced_icp_coordinated = icp_engine.analyze_invariance_enhanced(
        coordinated_data, price_cols
    )
    print(
        f"   ✓ Enhanced ICP Coordinated - Reject H0: {enhanced_icp_coordinated.reject_h0}"
    )
    print(
        f"   ✓ Enhanced ICP Coordinated - P-value: {enhanced_icp_coordinated.p_value:.4f}"
    )
    print(
    ...
    crypto_config = CryptoMomentConfig(
        max_lag=5, mirroring_window=3, spread_floor_threshold=0.0001
    )
    ...
    print(
        f"   ✓ Competitive - Max lead-lag beta: {summary_competitive['max_lead_lag_beta']:.4f}"
    )
    print(
    ...
    # Test on coordinated data
    moments_coordinated = crypto_calculator.calculate_moments(
        coordinated_data, price_cols
    )
    summary_coordinated = crypto_calculator.get_moment_summary(moments_coordinated)
    print(
        f"   ✓ Coordinated - Max lead-lag beta: {summary_coordinated['max_lead_lag_beta']:.4f}"
    )
    print(
    ...
    print(
        f"   ✓ Competitive - Risk classification: {result_competitive.risk_classification}"
    )
    print(
        f"   ✓ Competitive - Composite score: {result_competitive.composite_risk_score:.2f}"
    )
    ...
    print(
        f"   ✓ Coordinated - Risk classification: {result_coordinated.risk_classification}"
    )
    print(
        f"   ✓ Coordinated - Composite score: {result_coordinated.composite_risk_score:.2f}"
    )
