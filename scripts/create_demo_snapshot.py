...
def create_synthetic_tick_data(start_time: str, end_time: str, venue: str, base_price: float = 45000.0) -> pd.DataFrame:
...
def create_demo_snapshot():
    ...
    for venue, base_price in zip(venues, base_prices):
        ...
        tick_data = create_synthetic_tick_data(
            "2025-09-27T01:00:00+00:00",
            "2025-09-27T01:10:00+00:00",
            venue,
            base_price
        )
