...
def create_test_fixture() -> Dict[str, Any]:
    ...
    return {
        ...
        'env_counts': {
            'session': {'binance_europe': 500, 'coinbase_europe': 500, 'kraken_europe': 500},
            'vwap_side': {'binance_above': 250, 'binance_below': 250, 'coinbase_above': 250, 'coinbase_below': 250, 'kraken_above': 250, 'kraken_below': 250}
        },
        'min_bin_size': 5,
