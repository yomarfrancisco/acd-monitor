    ...
    def get_query_results(self, execution_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            return {
                ...
                "data_scanned": execution["QueryExecution"]["Statistics"].get(
                    "DataScannedInBytes", 0
                ),
                "execution_time": execution["QueryExecution"]["Statistics"].get(
                    "TotalExecutionTimeInMillis", 0
                ),
                "result_count": len(results.get("ResultSet", {}).get("Rows", []))
                - 1,  # Subtract header
            }
