...
def create_ci_role():
    ...
    try:
        ...
        # Update trust policy
        iam.update_assume_role_policy(RoleName=role_name, PolicyDocument=trust_policy_str)
...
def create_ci_policy():
    ...
    try:
        ...
        response = iam.create_policy_version(
            PolicyArn=policy_arn, PolicyDocument=json.dumps(policy_doc), SetAsDefault=True
        )
