                            ...
                            if time_range and '-' in time_range:
                                ...
                                try:
                                    ...
                                    high_coverage_venues = [
                                        venue for venue, data in coverage_json.items()
...
def generate_daily_report(symbols: List[str], days_back: int, bucket: str, prefix: str) -> Dict:
    ...
    try:
        ...
        if "error" in coverage_summary:
            ...
            coverage_summary = {"total_windows": 0, "venues_ok_windows": 0, "venues_ok_rate": 0}
...
def main():
    ...
    parser.add_argument("--output", default="reports/daily_status.json",
