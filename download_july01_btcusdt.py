#!/usr/bin/env python3
"""
Download July 1st, 2025 BTCUSDT data for all venues
"""
...
def download_july01_btcusdt():
    """Download July 1st, 2025 BTCUSDT data for all venues"""
    print("🔍 Downloading July 1st, 2025 BTCUSDT data")
    print("=" * 60)
    ...
    print(f"📊 Looking for BTCUSDT files")
    ...
    for venue in venues:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Find BTCUSDT file specifically
                btcusdt_file = None
                ...
                if btcusdt_file:
                    print(f"   Found BTCUSDT file: {btcusdt_file}")
                    
                    # Download the file
                    file_response = requests.get(btcusdt_file, headers=headers, timeout=120)
                    ...
                    print(f"   ❌ {venue}: No BTCUSDT file found")
            else:
...
if __name__ == '__main__':
    success = download_july01_btcusdt()
    if success:
        print("✅ All BTCUSDT files downloaded successfully")
    else:
        print("❌ Some BTCUSDT files failed to download")
