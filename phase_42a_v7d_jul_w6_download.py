#!/usr/bin/env python3
"""
Phase 42A-v7d: July Week-6 Download (One-Week Budget, Zero Waste)
Download only missing raw flat files for Week -6 (July 21-27)
"""
...
# Week -6 dates (UTC): 2025-07-21 → 2025-07-27
WEEK_6_DATES = [
    '20250721', '20250722', '20250723', '20250724', 
    '20250725', '20250726', '20250727'
]
...
def enumerate_expected_keys():
    """Enumerate expected keys for July 21-27 × 4 venues"""
    print("🔍 **Phase 42A-v7d: July Week-6 Download**")
    print("=" * 60)
    print(f"📊 API Key: {MASKED_KEY}")
    print(f"📊 Week -6 dates: {WEEK_6_DATES}")
    print(f"📊 Venues: {VENUES}")
    print(f"📊 Expected files: {len(WEEK_6_DATES)} × {len(VENUES)} = {len(WEEK_6_DATES) * len(VENUES)}")
...
def download_files(confirmed_files, api_counters):
    ...
    output_dir = 'data_v7/raw/coinapi_jul_w6'
...
def generate_reports(download_results, api_counters, diff_data):
    ...
    if manifest_data:
        ...
        manifest_path = 'data_v7/manifests/jul_w6_flatfiles_manifest.csv'
    ...
    if hash_data:
        ...
        hash_path = 'data_v7/manifests/jul_w6_hashes.csv'
...
def main():
    ...
    try:
        ...
        total_expected = len(WEEK_6_DATES) * len(VENUES)
        ...
        if successful_downloads > 0:
            print(f"✅ **Week -6 download completed successfully**")
        else:
            print(f"❌ **No files downloaded - check diagnostics**")
