# Candidate Model Card (Calibrated)
...
- **Temperature**: Temperature scaling (optimize NLL)
- **Selection**: Choose method with min ECE (tie → min Brier)
...
- **Conformal**: FPR ≤ 0.25 with coverage guarantees
...
- **Calibration Drift**: Monitor calibration over time
