...
def test_bybit_tickers():
    msg = {
      ...
      "data":{"ts": 1759392000123, "bid1Price":"110200.5", "ask1Price":"110300.5", "bid1Size":"1.5", "ask1Size":"2.0"}
    }
    out = parse_bybit(msg)
...
def test_kraken_trade_array():
    ...
    assert out["venue"]=="kraken" and out["last_px"]==110900.2 and out["symbol_alias"]=="BTC-USD"
