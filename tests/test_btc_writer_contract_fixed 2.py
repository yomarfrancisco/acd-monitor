...
from writer.pipelines.btc_usd import batch_contract, normalize_tick, validate_timestamp_window
...
def test_cross_field_consistency_fail():
    ...
    for px in [110_000.0] * 100:
        ...
        ticks.append(
            {"last_px": px, "best_bid": px + 50, "best_ask": px - 50}  # bid > last  # ask < last
        )
