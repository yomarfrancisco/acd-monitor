#!/usr/bin/env python3
"""
v1.4 Verification Run - Step 2: Adaptive Baseline Reproduction
Recreate adaptive baseline with structural break detection
"""
...
def generate_baseline_data():
    ...
    for i, date in enumerate(dates):
        if i < 7:  # Pre-break: mean 0.4
            daily_similarity = np.random.normal(0.4, 0.05)
...
def main():
    ...
    print("=== v1.4 Verification Run - Step 2: Adaptive Baseline Reproduction ===")
