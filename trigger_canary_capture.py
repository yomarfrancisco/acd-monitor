...
def trigger_canary_capture():
    ...
    print("🔧 Canary mode: ENABLED (writes to ticks_canary/)")
    ...
    print("   - Symbols: BTC-USD")
    print("   - Venues: binance,coinbase,kraken,okx,bybit")
    print("   - Canary mode: ✅ CHECKED")
    ...
    print(
        "📊 Check logs for: symbol validation, timestamp unit, median price, cross-field pass-rate"
    )
